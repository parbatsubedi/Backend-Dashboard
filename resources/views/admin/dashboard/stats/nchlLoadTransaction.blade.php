...
@section('content')
    <div class="wrapper wrapper-content">
        {{--Yesterday--}}
        <h2 style="margin-top: -15px; margin-left: 5px;"><b>NCHL Load Transaction</b> Yesterday (Date: {{ \Carbon\Carbon::yesterday()->format('Y-m-d') }})</h2>
        <div class="row">
            <div class="col-lg-2">
                <div class="ibox ">
        ...
        {{--Today--}}
        <h2 style="margin-top: -20px; margin-left: 5px;"><b>NCHL Load Transaction</b> Today (Date: {{ \Carbon\Carbon::today()->format('Y-m-d') }})</h2>
        <div class="row">
            <div class="col-lg-2">
                <div class="ibox ">
                    <div class="ibox-title" style="padding-right: 15px;">

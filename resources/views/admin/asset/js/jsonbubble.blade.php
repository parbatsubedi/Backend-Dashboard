<?php $url = Config::get('app.IS_SSL') ? "https://" : "http://" ?>
<script type="text/javascript" src="<?php echo $url+"json.bubblemix.net/jeditable.js" ?>"></script>
<script src="<?php echo $url+"json.bubblemix.net/jquery.contextMenu.js" ?>" type="text/javascript" charset="utf-8"></script>
